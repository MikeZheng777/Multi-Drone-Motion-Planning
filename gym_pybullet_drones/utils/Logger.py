...
class Logger(object):
    ...
    def plot_pos(self, pwm=False):
        ...
        plt.rc('axes', prop_cycle=(cycler('color', ['r', 'r'] + ['g','g'] + ['b','b'])))
        ...
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 0, :], linestyle='--', label="drone_"+str(j))
            axs[row, col].plot(t, self.controls[j, 0, :], linestyle='-', label="drone_"+str(j) + "_ref")
        ...
        row = 1
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 1, :],  linestyle='--', label="drone_"+str(j))
            axs[row, col].plot(t, self.controls[j, 1, :],  linestyle='-', label="drone_"+str(j) + "_ref")
        ...
        row = 2
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 2, :],  linestyle='--', label="drone_"+str(j))
            axs[row, col].plot(t, self.controls[j, 2, :],  linestyle='-', label="drone_"+str(j) + "_ref")
        ...
        row = 0
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 6, :],  linestyle='--', label="drone_"+str(j))
            axs[row, col].plot(t, self.controls[j, 3, :],  linestyle='-', label="drone_"+str(j) + "_ref")
        ...
        row = 1
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 7, :],  linestyle='--', label="drone_"+str(j))
            axs[row, col].plot(t, self.controls[j, 4, :],  linestyle='-', label="drone_"+str(j) + "_ref")
            axs[row, col].set_ylim([-2, 2])
        ...
        row = 2
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 8, :],  linestyle='--', label="drone_"+str(j))
            axs[row, col].plot(t, self.controls[j, 5, :],  linestyle='-', label="drone_"+str(j) + "_ref")
            axs[row, col].set_ylim([-2, 2])
    ...
    def plot_vel(self, pwm=False):
        ...
        """
        #### Loop over colors and line styles ######################
        plt.rc('axes', prop_cycle=(cycler('color', ['r', 'g', 'b']) + cycler('linestyle', ['-'])))
        fig, axs = plt.subplots(3, 2)
        t = np.arange(0, self.timestamps.shape[1]/self.LOGGING_FREQ_HZ, 1/self.LOGGING_FREQ_HZ)
